    ...
    if (loading) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-4">
                ...
                <p className="text-slate-400 font-bold uppercase tracking-widest text-[10px]">Loading Story Content...</p>
            </div>
        );
    }
        ...
        <div className="max-w-5xl mx-auto space-y-10 pb-20">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="flex items-center gap-5">
                    ...
                    <div>
                        <h1 className="text-3xl font-black text-slate-900 tracking-tight">Refine <span className="text-primary italic">Story</span></h1>
                        <p className="text-slate-500 font-medium">Updating: "{formData.title}"</p>
                    </div>
                </div>
                <button
            ...
            <form className="grid grid-cols-1 lg:grid-cols-3 gap-10" onSubmit={handleSubmit}>
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-soft space-y-4">
                        <h4 className="text-sm font-black uppercase tracking-widest text-slate-400">Public Slug</h4>
                        <div className="p-4 bg-slate-50 rounded-xl break-all">
                            <p className="text-[11px] font-mono text-slate-500">
                                /blog/<span className="text-primary font-bold">{formData.slug}</span>
                            </p>
                        </div>
                    </div>
                </div>
